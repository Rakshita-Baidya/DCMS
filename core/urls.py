...
from .views import (PatientViewSet, MedicalHistoryViewSet, DentalChartViewSet, ToothRecordViewSet, AppointmentViewSet,
                    TreatmentPlanViewSet, TreatmentRecordViewSet, TreatmentDoctorViewSet, PurchasedProductViewSet, PaymentViewSet, TransactionViewSet)
...
urlpatterns = [
    ...
    path('appointment/<int:appointment_id>/edit/<int:step>/',
    ...
    path('transaction/<int:transaction_id>/edit/',
    ...
    path('patients/<int:pk>/', PatientViewSet.as_view(
        {'get': 'retrieve', 'put': 'update', 'delete': 'destroy', 'post': 'create'}), name='patient'),

    # Medical History URLs
    path('medical-histories/list/',
         MedicalHistoryViewSet.as_view({'get': 'list'}), name='medical_history_list'),
    path('medical-histories/<int:pk>/', MedicalHistoryViewSet.as_view(
        {'get': 'retrieve', 'put': 'update', 'delete': 'destroy', 'post': 'create'}), name='medical_history'),

    # Dental Chart URLs
    path('dental-charts/list/',
         DentalChartViewSet.as_view({'get': 'list'}), name='dental_chart_list'),
    path('dental-charts/<int:pk>/', DentalChartViewSet.as_view(
        {'get': 'retrieve', 'put': 'update', 'delete': 'destroy', 'post': 'create'}), name='dental_chart'),

    # Tooth Record URLs
    path('tooth-records/list/',
         ToothRecordViewSet.as_view({'get': 'list'}), name='tooth_record_list'),
    path('tooth-records/<int:pk>/', ToothRecordViewSet.as_view(
        {'get': 'retrieve', 'put': 'update', 'delete': 'destroy', 'post': 'create'}), name='tooth_record'),

    # Appointment URLs
    path('appointments/list/',
         AppointmentViewSet.as_view({'get': 'list'}), name='appointment_list'),
    path('appointments/<int:pk>/', AppointmentViewSet.as_view(
        {'get': 'retrieve', 'put': 'update', 'delete': 'destroy', 'post': 'create'}), name='appointment'),

    # Treatment Plan URLs
    path('treatment-plans/list/',
         TreatmentPlanViewSet.as_view({'get': 'list'}), name='treatment_plan_list'),
    path('treatment-plans/<int:pk>/', TreatmentPlanViewSet.as_view(
        {'get': 'retrieve', 'put': 'update', 'delete': 'destroy', 'post': 'create'}), name='treatment_plan'),

    # Treatment Record URLs
    path('treatment-records/list/',
         TreatmentRecordViewSet.as_view({'get': 'list'}), name='treatment_record_list'),
    path('treatment-records/<int:pk>/', TreatmentRecordViewSet.as_view(
        {'get': 'retrieve', 'put': 'update', 'delete': 'destroy', 'post': 'create'}), name='treatment_record'),

    # Treatment Doctor URLs
    path('treatment-doctors/list/',
         TreatmentDoctorViewSet.as_view({'get': 'list'}), name='treatment_doctor_list'),
    path('treatment-doctors/<int:pk>/', TreatmentDoctorViewSet.as_view(
        {'get': 'retrieve', 'put': 'update', 'delete': 'destroy', 'post': 'create'}), name='treatment_doctor'),

    # Purchased Product URLs
    path('purchased-products/list/',
         PurchasedProductViewSet.as_view({'get': 'list'}), name='purchased_product_list'),
    path('purchased-products/<int:pk>/', PurchasedProductViewSet.as_view(
        {'get': 'retrieve', 'put': 'update', 'delete': 'destroy', 'post': 'create'}), name='purchased_product'),

    # Payment URLs
    path('payments/list/',
         PaymentViewSet.as_view({'get': 'list'}), name='payment_list'),
    path('payments/<int:pk>/', PaymentViewSet.as_view(
        {'get': 'retrieve', 'put': 'update', 'delete': 'destroy', 'post': 'create'}), name='payment'),

    # Transaction URLs
    path('transactions/list/',
         TransactionViewSet.as_view({'get': 'list'}), name='transaction_list'),
    path('transactions/<int:pk>/', TransactionViewSet.as_view(
        {'get': 'retrieve', 'put': 'update', 'delete': 'destroy', 'post': 'create'}), name='transaction'),
]
